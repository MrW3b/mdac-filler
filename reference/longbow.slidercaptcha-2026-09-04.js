(function () {
    ...
    var card = document.querySelector('.slidercaptcha .card-body');
    ...
    var extend = function () {
        ...
        for (var i = 1; i < length; i++) {
            ...
            for (var key in source) {
                // Using for in will iterate over all enumerable properties of the array, including its prototype.
    ...
    var SliderCaptcha = function (element, options) {
        options.width = card.clientWidth - 25;
    ...
    SliderCaptcha.DEFAULTS = {
        ...
        repeatIcon: 'icon icon-repeat',
        maxLoadCount: 3,
        localImages: function () {
            return 'images/slider/' + Math.round(Math.random() * 4) + '.jpg';
        },
    ...
    _proto.initDOM = function () {
        ...
        var sliderIcon = createElement('i', 'icon icon-arrow-right sliderIcon');
    ...
    _proto.initImg = function () {
        ...
        var loadCount = 0;
        img.onload = function () {
            // Randomly create slider position
        ...
        img.setSrc = function () {
            ...
            if (isIE) { // Internet Explorer cannot use img.crossOrigin for cross-domain requests. Instead, use AJAX to retrieve the image blob and then convert it to a dataURL for display.
    ...
    _proto.verify = function () {
        var arr = this.trail; // Distance moved along the y-axis when dragging
